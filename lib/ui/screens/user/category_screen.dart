                      ...
                      child: Container(
                          ...
                          child: Column(
                            ...
                            children: [
                              ...
                              const SizedBox(height: 6),
                              Text(LocaleKeys.product_info_books_category.tr(),
                                  style: AppTheme.semiLight(size: 17))
                            ],
                          )),
                    ),
                      ...
                      child: Container(
                          ...
                          child: Column(
                            ...
                            children: [
                              ...
                              const SizedBox(height: 6),
                              Text(
                                  LocaleKeys.product_info_clothes_category.tr(),
                                  style: AppTheme.semiLight(size: 17))
                            ],
                          )),
                    ),
                      ...
                      child: Container(
                          ...
                          child: Column(
                            ...
                            children: [
                              ...
                              const SizedBox(height: 6),
                              Text(LocaleKeys.product_info_animal_category.tr(),
                                  style: AppTheme.semiLight(size: 17))
                            ],
                          )),
                    ),
                      ...
                      child: Container(
                          ...
                          child: Column(
                            ...
                            children: [
                              ...
                              const SizedBox(height: 6),
                              Text(
                                  LocaleKeys.product_info_kitchen_category.tr(),
                                  style: AppTheme.semiLight(size: 17))
                            ],
                          )),
                    ),
                      ...
                      child: Container(
                          ...
                          child: Column(
                            ...
                            children: [
                              ...
                              const SizedBox(height: 6),
                              Text(LocaleKeys.product_info_beauty_category.tr(),
                                  style: AppTheme.semiLight(size: 17))
                            ],
                          )),
                    ),
                      ...
                      child: Container(
                          ...
                          child: Column(
                            ...
                            children: [
                              ...
                              const SizedBox(height: 6),
                              Text(LocaleKeys.product_info_soska_category.tr(),
                                  style: AppTheme.semiLight(size: 17))
                            ],
                          )),
                    ),
