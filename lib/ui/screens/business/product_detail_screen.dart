                        ...
                        children: [
                          ...
                          Row(
                            ...
                            children: [
                              CustomRadio(
                                label:
                                    LocaleKeys.add_product_product_type_3.tr(),
                                ismultiLine: true,
                                value: true,
                              ),
                              CustomRadio(
                                label:
                                    LocaleKeys.add_product_product_type_2.tr(),
                                value: false,
                                ismultiLine: true,
                              ),
                              CustomRadio(
                                label:
                                    LocaleKeys.add_product_product_type_1.tr(),
                                value: false,
                                ismultiLine: true,
                              ),
                            ],
                      ...
                      Container(
                        ...
                        child: Column(
                          ...
                          children: [
                            ...
                            Text(
                              LocaleKeys.add_product_product_video_desc.tr(),
                              style: AppTheme.regular(
                                  size: 14, color: AppColors.textGray),
                            ),
                            const SizedBox(
                            ...
                            Center(
                              child: SizedBox(
                                ...
                                child: IconBox(
                                  ...
                                  text: LocaleKeys.add_product_video_camera_desc
                                      .tr(),
                                ),
                              ),
                            ),
                      ...
                      Container(
                        ...
                        child: Column(
                          children: [
                              ...
                              children: [
                                Expanded(
                                  child: Column(
                                    children: [
                                      CustomRadio(
                                        label: LocaleKeys.add_product_discount
                                            .tr(),
                                        value: false,
                                      ),
                                      const SizedBox(
                                ...
                                Expanded(
                                  child: Column(
                                    children: [
                                      CustomRadio(
                                        label:
                                            LocaleKeys.add_product_inPrice.tr(),
                                        value: false,
                                      ),
                                      const SizedBox(
                                        height: 4,
                            ...
                            CustomCheckbox(
                              label:
                                  LocaleKeys.add_product_for_all_in_store.tr(),
                              value: false,
                              onTap: () => {},
                            ),
                          ],
                              ...
                              children: [
                                Expanded(
                                  ...
                                  child: CustomInput(
                                    ...
                                    label: LocaleKeys.add_product_delivery_price
                                        .tr(),
                                  ),
                                ),
                                const Spacer(
